...
<body class="h-screen text-slate-400 bg-slate-900">
    ...
    <div class="m-5 flex justify-center antialiased text-slate-400 bg-slate-900">
        ...
        <div class="bg-black grid grid-cols-3 gap-10 h-80 w-[100vw]">
             <div class="bg-white">
            <h2 class="text-center text-5xl p-5 font-mono whitespace-pre text-slate-200  leading-6 font-black">Information</h2>
            <div class="overflow-hidden  bg-black font-mono font-medium p-4 leading-6 text-sky-500 hover:font-black whitespace-nowrap hover:border-slate-200 text-sky-400 border border-slate-100 dark:border-slate-400/10">
       ...
       <div>
           <h2 class="overflow-hidden text-center text-5xl p-5 font-mono self-start whitespace-pre text-slate-200  leading-6 font-black">Destination</h2>
           <div class="overflow-hidden max-w-auto bg-white font-mono font-medium p-4 leading-6 text-sky-500 hover:font-black whitespace-nowrap hover:border-slate-200 text-sky-400 border border-slate-100 dark:border-slate-400/10">
         ...
         <div>
             <h2 class="text-center text-5xl p-5 font-mono whitespace-pre text-slate-200  leading-6 font-black">Receiver</h2>
