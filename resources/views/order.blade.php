    ...
    <div class="m-5 flex justify-center antialiased text-slate-400 bg-slate-900">
        <div class=" grid grid-cols-3 gap-10 w-[100vw]">
                 <div class="overflow-hidden   font-mono font-medium p-4 leading-6 text-sky-500 hover:font-black whitespace-nowrap hover:border-slate-200 text-sky-400 border border-slate-100 dark:border-slate-400/10">
                    <h2 class="text-center  mb-5  text-5xl p-5 font-mono whitespace-pre text-slate-200 font-black leading-6 ">Information</h2>
                <h3 class="text-center text-2xl p-1 font-mono whitespace-pre text-sky-400 leading-6 ">Status: {{$order['status']}}</h3>
                <h3 class="text-center text-2xl p-1 font-mono whitespace-pre text-sky-400 leading-6 ">Category: {{$order['category']}}</h3>
                <h3 class="text-center text-2xl p-1 font-mono whitespace-pre text-sky-400 leading-6 ">Package: {{$order['packageType']}}</h3>
       </div>
           ...
           <div class="overflow-hidden max-w-auto  font-mono font-medium p-4 leading-6 text-sky-500 hover:font-black whitespace-nowrap hover:border-slate-200 text-sky-400 border border-slate-100 dark:border-slate-400/10">
            ...
            <div class="grid grid-cols-2 gap-10 w-[100vw] px-20">
                <h3 class="overflow-hidden max-w-auto  font-mono font-medium p-4 leading-6 text-sky-500 hover:font-black whitespace-nowrap hover:border-slate-200 text-sky-400 border border-slate-100 dark:border-slate-400/10 text-center text-2xl p-1 font-mono whitespace-pre text-sky-400 leading-6">Weight: {{$order['weight']}} KG</h3>
                <h3 class="overflow-hidden max-w-auto  font-mono font-medium p-4 leading-6 text-sky-500 hover:font-black whitespace-nowrap hover:border-slate-200 text-sky-400 border border-slate-100 dark:border-slate-400/10 text-center text-2xl p-1 font-mono whitespace-pre text-sky-400 leading-6">Timestamp: {{$order['timestamp']}}</h3>
         </div>
         
    @foreach (array_reverse($order['events']) as $event) 
        <div class="grid gap-10 grid-cols-3 mt-3 borderw-[100%] px-20">
